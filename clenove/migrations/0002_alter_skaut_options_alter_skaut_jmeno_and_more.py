...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='skaut',
            name='prezdivka',
            field=models.CharField(help_text='Prosim, zadavejte bez diakritiky', max_length=100, verbose_name='Přezdivka'),
        ),
        migrations.AlterField(
            model_name='skaut',
            name='splneno',
            field=models.BooleanField(default=False, help_text='Uz uplnil skautsku zkousku?'),
        ),
        migrations.AlterField(
            model_name='skaut',
            name='vek',
